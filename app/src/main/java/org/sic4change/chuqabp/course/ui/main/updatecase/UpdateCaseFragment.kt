...
class UpdateCaseFragment: Fragment() {
    ...
    private lateinit var component: UpdateCaseFragmentComponent
    private val viewModel by lazy {
        getViewModel { component.updateCaseViewModel }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        component = app.component.plus(UpdateCaseFragmentModule((args.id)))
